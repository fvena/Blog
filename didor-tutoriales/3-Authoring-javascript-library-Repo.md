...
> Recuerda que esta compración solo se realizará sobre los archivos que vamos a comitear (staged files), por lo que no es necesario especificar que directorios deben ignorar.
